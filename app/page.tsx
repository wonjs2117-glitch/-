    ...
    <div className="bg-white min-h-screen font-serif text-[#1a1a1a] antialiased">
      ...
      <header className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] md:text-[12px] font-sans font-medium tracking-[0.5em] text-gray-400 mt-3 uppercase">Truth & Trust</p>
        </div>
      ...
      <footer className="border-t border-black max-w-7xl mx-auto px-4 md:px-6 py-16 mb-20 mt-10">
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 font-serif tracking-tighter uppercase">The Daily Major</h2>
